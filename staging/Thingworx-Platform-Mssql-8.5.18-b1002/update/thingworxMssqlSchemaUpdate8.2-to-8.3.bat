...
sqlcmd -S %server%\%serverinstance%,%port% -U %loginname% -v database=%database% -d %database% -i ./thingworx-update-model-schema-8.2-to-8.3.sql
sqlcmd -S %server%\%serverinstance%,%port% -U %loginname% -v database=%database% -d %database% -i ./thingworx-update-data-schema-8.2-to-8.3.sql
sqlcmd -S %server%\%serverinstance%,%port% -U %loginname% -v database=%database% -d %database% -i ./thingworx-update-property-schema-8.2-to-8.3.sql
sqlcmd -S %server%\%serverinstance%,%port% -U %loginname% -v database=%database% -d %database% -i ./thingworx-update-grants-schema-8.2-to-8.3.sql
pause
)

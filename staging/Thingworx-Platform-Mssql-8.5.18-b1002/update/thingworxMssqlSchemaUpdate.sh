...
then
 ...
 sqlcmd -S $server\\$serverinstance,$port -U $loginname -P $password -d $database -i thingworx-update-model-schema-8.4-to-8.5.sql
 sqlcmd -S $server\\$serverinstance,$port -U $loginname -P $password -d $database -i thingworx-update-data-schema-8.4-to-8.5.sql
 sqlcmd -S $server\\$serverinstance,$port -U $loginname -P $password -d $database -i thingworx-update-property-schema-8.4-to-8.5.sql
 sqlcmd -S $server\\$serverinstance,$port -U $loginname -P $password -d $database -i thingworx-update-grants-schema-8.4-to-8.5.sql 
fi
